...
public abstract class DateUtils {
    ...
    public static final String DATE_TIME_FORMAT_ = "yyyy/MM/dd HH:mm";
    ...
    /** 返回yyyy/MM/dd HH:mm格式的字符串时间 */
    public static final SimpleDateFormat DATE_TIME_FORMAT_FORMAT_ = new SimpleDateFormat(DATE_TIME_FORMAT_);
    /** 返回yyyyMMddHHmmss格式的字符串时间 */
    public static final SimpleDateFormat TIME_STAMP_FORMAT_FORMAT = new SimpleDateFormat(TIME_STAMP_FORMAT);
    ...
    static {
        ...
        PATTERN_CACHES.put(YEAR_FORMAT,YEAR_FORMAT_FORMAT);
        PATTERN_CACHES.put(DATE_TIME_FORMAT_,DATE_TIME_FORMAT_FORMAT_);
        PATTERN_CACHES.put(TIME_STAMP_FORMAT,TIME_STAMP_FORMAT_FORMAT);
    }
    ...
    */
   public static Date string2dateTime_(String source){
       try {
           return DATE_TIME_FORMAT_FORMAT_.parse(source);
       } catch (ParseException e) {
           return now();
       }
   }
    ...
    public static String getTimeStamp(){
        return TIME_STAMP_FORMAT_FORMAT.format(now());
    }
    ...
    public static Date timeStamp2Date(String timeStamp){
        try {
            return TIME_STAMP_FORMAT_FORMAT.parse(timeStamp);
        } catch (ParseException e) {
            return now();
        }
    }
