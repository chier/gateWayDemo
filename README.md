...
| 术语   | 说明 | 
| ----   |----   |
| 商户号 | 支付系统分配给商户的唯一标识。 100512501190760 |
| 商户 key| 调用服务接口所需要的密钥 (9d6c8a99-4b3b-40d2-ad48-58f16c809293) |
| 商户 secret | 签名的密钥 (505d777b-6cd3-4cf3-a7c9-ff13fb5bea96) |
...
| merchantId	| 商户号 | y|
| amount	| 订单金额|y |
| trxType	| 交易类型  默认传3   T0(1,"T0"), T1(2,"T1"), D0(3,"D0");|y |
